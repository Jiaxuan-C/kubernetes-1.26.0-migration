...
func (f *FakeRuntime) CheckpointPod(ctx context.Context, pod *v1.Pod, podStatus *kubecontainer.PodStatus, options *kubecontainer.MigratePodOptions) {
	// TODO(cjx.bupt): Needn't to implement.
}
