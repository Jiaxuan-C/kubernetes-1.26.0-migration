...
// MigratePodOptions contains checkpoint options TODO(cjx.bupt)
...
type Runtime interface {
	...
	// PreCheckpointPod TODO(cjx.bupt)
	CheckpointPod(ctx context.Context, pod *v1.Pod, podStatus *PodStatus, options *MigratePodOptions)
