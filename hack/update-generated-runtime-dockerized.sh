...
# C:\goproject\src\k8s.io\kubernetes\staging\src\k8s.io\cri-api\pkg\apis\runtime\
...
function generate_code() {
	...
	# C:\goproject\src\k8s.io\kubernetes\staging\src\k8s.io\cri-api\pkg\apis\runtime\v1
	KUBE_REMOTE_RUNTIME_PATH="${KUBE_REMOTE_RUNTIME_ROOT}/${RUNTIME_API_VERSION}"
	protoc \
	--proto_path="${KUBE_REMOTE_RUNTIME_PATH}" \
	# C:\goproject\src\k8s.io\kubernetes\
